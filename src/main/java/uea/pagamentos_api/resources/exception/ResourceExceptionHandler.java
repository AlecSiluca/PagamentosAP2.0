package uea.pagamentos_api.resources.exception;
...
public class ResourceExceptionHandler  {
	...
	public ResponseEntity<StandardError> pessoaInativaException(PessoaInativaException e, HttpServletRequest Request){
		List<String> erros = Arrays.asList(messageSource.getMessage("mensagem.pessoa.inativa", null, LocaleContextHolder.getLocale()));
